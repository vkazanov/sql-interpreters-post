* Введение
  ...
  больше 20 миллиардов событий, отправляемых с пользовательских устройств, и на порядок больше
  технических уведомлений. До определенных объемов данных и в рамках стандартных задач почти всегда
  хватает возможностей уже существующих баз данных.
  ...
  данных работать не могут, либо работают медленно; распределенные же БД позволяют работать с
  большими объемами данных, но выполняют запросы еще медленней.

  По ходу решения этих проблем наша группа разработала несколько небольших баз данных,
  ориентированных на эффективное выполнения небольшого числа интересных нам запросов. Поначалу сами
  языки запросов и их интерпретаторы были наивными, и нам, разработчиками, приходилось постоянно их
  дорабатывать, и каждая доработка занимала непропорционально много времени.
